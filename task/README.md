...
3. [Техническое руководство для начинающих](#3-техническое-руководство-для-начинающих)
...
### Шаг 5.2. Установите библиотеку для бота
...
### Шаг 5.3. Создайте папку для проекта
...
### Шаг 6.1. Откройте редактор кода
